...
final class RouterTests: XCTestCase {
    ...
    func testSimpleRouteMatching() throws {
        ...
        // Add route to router
        router.addRoute(method: .get, pattern: "/user/{id}") { req, res in
    ...
    func testMultipleParameterRouteMatching() throws {
        ...
        router.addRoute(method: .get, pattern: "/user/{userId}/posts/{postId}") { req, res in
            // Handler implementation
        }
    ...
    func testExactPathMatching() throws {
        ...
        router.addRoute(method: .get, pattern: "/api/status") { req, res in
            // Handler implementation
        }
